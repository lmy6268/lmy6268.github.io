...
! function (t, e) {
    ...
    function i() {
        ...
        L = N("button"), L.setAttribute("type", "button"), L.id = "close-button", L.setAttribute("aria-label", "Close"), L.innerHTML = M.svg ? q : "&times;", 
        S.appendChild(L), F.className = H.className = L.className = "baguetteBox-button", void r())
    }
    ...
    function u(t, e) {
        if (R !== t) {
            ...
            W.length = 0;
            for (var n, o = [], i = [], a = 0; a < t.length; a++) n = N("div"), n.oncontextmenu = function () { return false }, n.className = "full-image", n.id = "baguette-img-" + a, W.push(n), o.push("baguetteBox-figure-" + a), i.push("baguetteBox-figcaption-" + a), P.appendChild(W[a]);
    ...
    function m(t, e) {
        ...
        if ("undefined" != typeof n) {
            ...
            if (l.id = "baguetteBox-figure-" + t, l.innerHTML = '<div class="baguetteBox-spinner"><div class="baguetteBox-double-bounce1"></div><div class="baguetteBox-double-bounce2"></div></div>', j.captions && a) {
                var u = N("figcaption");
                l.oncontextmenu = function () { return false };
    ...
    function E(t, e, n, o) {
        ...
        // t.addEventListener("contextmenu",false); 
    }
